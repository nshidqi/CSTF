...
from .cswin_general import CSWinBlock 
...
class SymmetricalTransFormer_cswin_general_window_4_4_4_4(CompressionModel):
    def __init__(self,
                 pretrain_img_size=256,
                 patch_size=2,
                 in_chans=3,
...
class SymmetricalTransFormer_cswin_general_window_2_2_2_2(CompressionModel):
    def __init__(self,
                 pretrain_img_size=256,
                 patch_size=2,
                 in_chans=3,
